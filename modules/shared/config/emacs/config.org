...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "fiqrimasngot"
    user-mail-address "fiqrihakim97@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/fiqrim/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/fiqrim/bin" "/profile/bin" "/Users/fiqrim/.npm-packages/bin" "/Users/fiqrim/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
